...
public class WeatherBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        temperature.setText(String.valueOf(intent.getIntExtra(WeatherService.EXTRA_TEMPERATURE, 0)));
        humidity.setText(String.valueOf(intent.getIntExtra(WeatherService.EXTRA_HUMIDITY, 0)));
    }
}